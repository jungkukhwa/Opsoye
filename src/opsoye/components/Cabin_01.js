  ...
  return (
    <div className="cabin">
      ...
      <div style={cabin} className="cabin_content">
        ...
        <ul className="tab">
          {/* <li>
            <a href={`${process.env.PUBLIC_URL}/Cabin_01`} className="active">
              한라봉
            </a>
          </li>
          <li>
            <a href={`${process.env.PUBLIC_URL}/Cabin_02`}>감귤</a>
          </li>
          <li>
            <a href={`${process.env.PUBLIC_URL}/Cabin_03`}>돌하르방</a>
          </li> */}
          {/* <li>
          ...
          <li>
            <a href="/Cabin_02">한라봉</a>
          </li>
          <li>
            <a href="/Cabin_03">한라봉</a>
          </li> */}
          {/* <li>
            <a href="/Cabin_01" className="active">
              한라봉
